...
public:
    ...
    void hal_name()
    {
        ...
        {
            case 1:
            hall_name="SVF BENACHITY";
            break;
             case 2:
            hall_name="ARTI CINEMAHALL";
            break;
             case 3:
            hall_name="CITYCENTRE MOVIEHALL";
            break;
             case 4:
            hall_name="BIOSCOPE JUNCTIONMALL";
            break;
        }
...
int main()
{
    ...
    while(1)
    {
        cout<<"\n\n\t\t\t\t\t\t\t PRESS 1 TO BOOK TICKET IN SVF BENACHITY";
    cout<<"\n\n\t\t\t\t\t\t\t PRESS 2 TO BOOK TICKET IN ARTI CINEMAHALL";
    cout<<"\n\n\t\t\t\t\t\t\t PRESS 3 TO BOOK TICKET IN CITYCENTRE MOVIEHALL";
    cout<<"\n\n\t\t\t\t\t\t\t PRESS 4 TO BOOK TICKET IN BIOSCOPE JUNCTIONMALL";
    ...
    switch(obn)
    {
        case 1:
            cout<<"\t\t\t\t\t\t\t";
            cout<<"SVF BENACHITY IS SELECTED\n";
        obj[0].first();
        break;
        case 2:
        cout<<"\t\t\t\t\t\t\t";
            cout<<"ARTI CINEMAHALL IS SELECTED\n";
        obj[1].first();
        break;
        case 3:
        cout<<"\t\t\t\t\t\t\t";
        ...
        case 4:
        cout<<"\t\t\t\t\t\t\t";
            cout<<"BIOSCOPE JUNCTIONMALL  IS SELECTED\n";
        obj[3].first();
        break;
        case 9:
                goto bye;
